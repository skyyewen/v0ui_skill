...
Create modern, polished, v0-like frontend work by narrowing the design space: reuse the existing stack, prefer component primitives, rely on design tokens, apply proven layout patterns, include real interaction states, and verify the rendered UI.
...
4. Prefer existing components and tokens before adding custom CSS or dependencies.
5. Implement complete responsive UI, including empty, loading, error, hover, focus, disabled, and selected states when relevant.
6. Run the project and inspect the result in desktop and mobile viewports before claiming completion.
